...
'<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="about.php"><img src="img/logo.jpeg" height="40px" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/joy/contact.php?">Contact Us</a>
                </li>
          ...
          echo
            ...
            <form class="d-frex my-2" action="/joy/logout.php">
            ...
            <p class="text-warning my-0 mx-2"> Welcome '. $_SESSION['user_name'] .' </p>';
                ...
                <form class="d-frex" action="/joy/login.php">
                    <button class="btn btn-outline-success me-2" type="submit">Login</button>
    
                </form>
                <form class="d-frex" action="/joy/singup.php">
