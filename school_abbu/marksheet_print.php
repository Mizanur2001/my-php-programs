              ...
              elseif($_GET['s']==3){
                ...
                '<table class="myTable">
                    ...
                    <tr>
                        ...
                        $total = add($bengali , $be_s1_p , $be_s2_w , $be_s2_p);
                        $avg_be=round(($total+add_2($be_s3_w,$be_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_be);
                    ...
                    <tr>
                        ...
                        $total=add($english , $en_s1_p , $en_s2_w , $en_s2_p); 
                        $avg_en=round(($total+add_2($en_s3_w,$en_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_en);
                    ...
                    <tr>
                        ...
                        $total=add($history,$hi_s1_p,$hi_s2_w,$hi_s2_p);
                        $avg_hi=round(($total+add_2($hi_s3_w,$hi_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_hi);
                    ...
                    <tr>
                        ...
                        $total=add($geography , $ge_s1_p , $ge_s2_w , $ge_s2_p);
                        $avg_ge=round(($total+add_2($ge_s3_w,$ge_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_ge);
                    ...
                    <tr>
                        ...
                        $total=add($mathematics , $ma_s1_p , $ma_s2_w , $ma_s2_p);
                        $avg_ma=round(($total+add_2($ma_s3_w,$ma_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_ma);
                    ...
                    <tr>
                        ...
                        $total=add($physics , $ph_s1_p , $ph_s2_w , $ph_s2_p);
                        $avg_ph=round(($total+add_2($ph_s3_w,$ph_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_ph);
                    ...
                    <tr>
                        ...
                        $total=add($lscience , $li_s1_p , $li_s2_w , $li_s2_p) ; 
                        $avg_li=round(($total+add_2($li_s3_w,$li_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_li);
                    ...
                    <tr>
                        ...
                        $total=add($islam_parichay , $is_s1_p , $is_s2_w , $is_s2_p);
                        $avg_ip=round(($total+add_2($is_s3_w,$is_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_ip);
                    ...
                    <tr>
                        ...
                        $total=add($arabic , $ar_s1_p , $ar_s2_w , $ar_s2_p);
                        $avg_ar=round(($total+add_2($ar_s3_w,$ar_s3_p))/2,0,PHP_ROUND_HALF_UP);
                        $grade=check($avg_ar);
                ...
                '<p class="mt-20">Result : </p>
                 <p class="mt-20">Grand-Total :' .$avg_be+$avg_en+$avg_hi+$avg_ge+$avg_ma+$avg_ph+$avg_li+$avg_ip.'</p>
                 <p class="mt-20">Position in Class:<p>
            </div>
            <div class="sign">
